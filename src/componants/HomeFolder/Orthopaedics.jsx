...
//         <div
//           className=" max-w-screen-xl mx-auto justify-between mt-5 
...
//           <div
//             className=" items-center justify-between text-sm mx-48
//    lg:flex md:flex sm:hidden hidden"
//           >
//             <div className="">
...
//             <div>
//               <p className="w-80 mt-6">
//                 Osteoarthritis refers to the process of degeneration of
//                 protective cartilages around the bones. It is the most common
//                 form of arthritis, and it can damage any joint in the body,
//                 mostly the hands, knees, hips, and spinal cord. Call
//                 +91-124-4141414 to know more about its causes, symptoms and
//                 treatment.
//               </p>
//             </div>
//           </div>
...
//               <p>
//                 Among India largest and one of the world most successful
...
import img39 from "../../../public/images/img39.png";
import img40 from "../../../public/images/img40.png";
import img50 from '../../../public/images/img50.png'
import { MdOutlineKeyboardArrowRight } from "react-icons/md";
import { PiNumberCircleZeroLight } from "react-icons/pi";
import img41 from "../../../public/images/img41.png";
import { Swiper, SwiperSlide } from "swiper/react";
...
import Accordionthree from "../accordionitems/Accordionthree";
import Accordionfour from "../accordionitems/Accordionfour";
     ...
     lg:flex md:flex sm:hidden hidden p-7"
        >
          <div className="  ">
            ...
            <h1 className="text-center sm:hidden hidden lg:block md:block font-semibold text-xl ">Orthopaedics</h1>
            <NavLink to='/contact'>
          ...
          <div className=" ">
            <img src={img7} alt="" className=" w-[450px] mt-10" />
          </div>
      ...
      <div className="max-w-screen-xl lg:mx-auto mx-5 mt-5  ">
        <div className="lg:flex md:flex hidden lg:flex-row md:flex-row justify-center items-center gap-10">
          <div>
            ...
            <hr className="lg:w-60 md:w-36  border-t-2 border-[#aea9a9] my-1 mx-auto" />
            <div className="flex justify-between text-[#086AAE]">
              <h1 className="">Paediatric Orthopaedics</h1>
              <MdOutlineKeyboardArrowRight className="  " />
            </div>
          ...
          <div>
            <img src={img13} alt="" className="lg:w-52 md:w-40 mt-6" />
          </div>
          <div>
            <p className="lg:w-96 md:w-80 text-xs ">
            Sports injuries cover a range of conditions, such as 
knee sports
...
{" "}
      ...
      <div className="max-w-screen-xl lg:mx-auto mx-5 mt-5 mb-10 ">
        <div className="lg:flex md:flex hidden lg:flex-row md:flex-row justify-center items-center gap-10">
          ...
          <div>
            <img src={img15} alt="" className="lg:w-52 md:w-40 mt-6" />
          </div>
          <div>
            <p className="lg:w-96 md:w-80 text-xs ">
            Osteoarthritis refers to the process of degeneration of 
...
<div className="bg-[#D9D9D9] lg:hidden md:hidden p-6 -mt-14 ">


      
     <h1 className="text-center lg:hidden md:hidden block font-semibold text-xl ">Orthopaedics</h1>
      <div className="lg:hidden md:hidden mt-3 flex justify-center items-center ">
        <img src={img50} alt="" />
      </div>
      ...
      <div className="flex mt-4 lg:hidden md:hidden  mx-6  items-center  justify-center   ">
        ...
        >
          <SwiperSlide>
            <div className="flex flex-col h-[356px]     rounded-2xl border ">
              <img src={img8} alt="" className="    rounded-t-2xl  -mt-4  " />
              <p className="w-72 text-sm ml-2 p-3 mt-0.5">
                A team of cardiac surgeons, interventional cardiologists and
                interventional cardiologist works seamlessly to ensure that each
                patient receives the benefit of comprehensive advice that is
          ...
          <SwiperSlide>
            <div className="flex flex-col h-[356px]     rounded-2xl border ">
              <img src={img9} alt="" className="    rounded-t-2xl  -mt-4  " />
              <p className="w-72 text-sm ml-2 p-3 mt-0.5">
                A team of cardiac surgeons, interventional cardiologists and
                interventional cardiologist works seamlessly to ensure that each
                patient receives the benefit of comprehensive advice that is
          ...
          <SwiperSlide>
            <div className="flex flex-col h-[356px]     rounded-2xl border ">
              <img src={img10} alt="" className="    rounded-t-2xl  -mt-4  " />
              <p className="w-72 text-sm ml-2 p-3 mt-0.5">
                A team of cardiac surgeons, interventional cardiologists and
                interventional cardiologist works seamlessly to ensure that each
                patient receives the benefit of comprehensive advice that is
